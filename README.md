...
./bin/processSingleTrial ~/data/kuopio-gait-dataset-processed-v2 ./bin/calibrated_KUOPIO_base_R_pelvis_relaxed.osim ~/data/alex-random-test 09 l_comf 01 3.5 4.5
