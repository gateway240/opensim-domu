#ifndef SimTK_SIMBODY_ASSEMBLY_CONDITION_EXT_H_
#define SimTK_SIMBODY_ASSEMBLY_CONDITION_EXT_H_
...
if you're not sure. **/
const AssemblerExt& getAssembler() const 
...
initialization. **/
QIndex getQIndexOfFreeQ(AssemblerExt::FreeQIndex fx) const
...
initialization. **/
AssemblerExt::FreeQIndex getFreeQIndexOfQ(QIndex qx) const
...
// is adopted.
friend class AssemblerExt;
void setAssembler(const AssemblerExt& assembler, AssemblyConditionIndex acx) {
...
const AssemblerExt*        assembler;
AssemblyConditionIndex  myAssemblyConditionIndex;
};

} // namespace SimTK

#endif // SimTK_SIMBODY_ASSEMBLY_CONDITION_EXT_H_
