#ifndef _DistanceKinematics_h_
#define _DistanceKinematics_h_
/* -------------------------------------------------------------------------- *
 *                        OpenSim:  DistanceKinematics.h                         *
 * -------------------------------------------------------------------------- *
...
const int DistanceKinematicsNAME_LENGTH = 256;
const int DistanceKinematicsBUFFER_LENGTH = 2048;
 ...
 * @version 1.0
 */
class OSIMANALYSES_API DistanceKinematics : public Analysis {
OpenSim_DECLARE_CONCRETE_OBJECT(DistanceKinematics, Analysis);
...
private:
    //char _buffer[DistanceKinematicsBUFFER_LENGTH];
    //char _tmp[DistanceKinematicsBUFFER_LENGTH];
...
//=============================================================================
public:
    DistanceKinematics(Model *aModel=0);
    DistanceKinematics(const std::string &aFileName);
    DistanceKinematics(const DistanceKinematics &aObject);
    virtual ~DistanceKinematics();
...
public:
    ...
    //--------------------------------------------------------------------------
#ifndef SWIG
    DistanceKinematics& operator=(const DistanceKinematics &aDistanceKinematics);
#endif
public:
    //--------------------------------------------------------------------------
    // GET AND SET
...
//=============================================================================
};  // END of class DistanceKinematics
...
#endif // #ifndef __DistanceKinematics_h__
