...
public:
    ...
    void setGenericModelMaker(GenericModelMaker& genericModelMaker) {
        _genericModelMaker = genericModelMaker;
        _genericModelMakerProp.setValueIsDefault(false);
    }

    const ModelScaler& getModelScaler() const
    { return _modelScaler; }
    void setModelScaler(ModelScaler& modelScaler) {
        _modelScaler = modelScaler;
        _modelScalerProp.setValueIsDefault(false);
    }

    const MarkerPlacer& getMarkerPlacer() const
    { return _markerPlacer; }
    void setMarkerPlacer(MarkerPlacer& markerPlacer) {
        _markerPlacer = markerPlacer;
        _markerPlacerProp.setValueIsDefault(false);
    }
