...
public:
   ...
   void copyData(const Measurement &aMeasurement);
    ...
    void setBodyScaleSet(BodyScaleSet& bodyScaleSet) { 
        _bodyScaleSet = bodyScaleSet; 
        _bodyScaleSetProp.setValueIsDefault(false);
    }

    MarkerPairSet& getMarkerPairSet() { return _markerPairSet; }
    void setMarkerPairSet(MarkerPairSet& markerPairSet) {
        _markerPairSet = markerPairSet;
        _markerPairSetProp.setValueIsDefault(false);
    }
