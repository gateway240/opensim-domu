#ifndef _RegisterTypes_osimSimulationExtension_h_
#define _RegisterTypes_osimSimulationExtension_h_
/* -------------------------------------------------------------------------- *
...
// Excluding this from Doxygen until it has better documentation! -Sam Hamner
    /// @cond 
class osimSimulationExtensionInstantiator 
{ 
public: 
        osimSimulationExtensionInstantiator(); 
private: 
        void registerDllClasses(); 
}; 
/// @endcond

#endif // __RegisterTypes_osimSimulationExtension_h__
