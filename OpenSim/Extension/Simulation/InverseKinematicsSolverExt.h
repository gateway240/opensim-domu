#ifndef OPENSIM_INVERSE_KINEMATICS_SOLVER_EXT_H_
#define OPENSIM_INVERSE_KINEMATICS_SOLVER_EXT_H_
/* -------------------------------------------------------------------------- *
 *                    OpenSim:  InverseKinematicsSolverExt.h                     *
 * -------------------------------------------------------------------------- *
 ...
 * values. The InverseKinematicsSolverExt provides the option to convert the
 ...
 * solution.
 *
 * The InverseKinematicsSolverExt objective:
 * \f[
 ...
 * @author Ajay Seth
 */
class OSIMSIMULATION_API InverseKinematicsSolverExt: public AssemblySolver
{
//==============================================================================
// METHODS
//==============================================================================
public:
    ...
    // CONSTRUCTION
    //--------------------------------------------------------------------------
    virtual ~InverseKinematicsSolverExt() {}
    // No need for copy constructor or operator
    InverseKinematicsSolverExt(const InverseKinematicsSolverExt& other)            = delete;
    InverseKinematicsSolverExt& operator=(const InverseKinematicsSolverExt& other) = delete;

    InverseKinematicsSolverExt(const Model& model, 
    ...
    InverseKinematicsSolverExt(const Model& model,
            ...
            SimTK::Array_<CoordinateReference>& coordinateReferences,
            double constraintWeight = SimTK::Infinity): 
        InverseKinematicsSolverExt(model,
...
//=============================================================================
};  // END of class InverseKinematicsSolverExt
//=============================================================================
} // namespace

#endif // OPENSIM_INVERSE_KINEMATICS_SOLVER_EXT_H_
