#ifndef OPENSIM_EXT_IMU_PLACER_H_
#define OPENSIM_EXT_IMU_PLACER_H_
/* -------------------------------------------------------------------------- *
 *                          OpenSim:  IMUPlacerExt.h                             *
 * -------------------------------------------------------------------------- *
 ...
 */
class OSIMSIMULATION_API IMUPlacerExt : public Object {
    OpenSim_DECLARE_CONCRETE_OBJECT(IMUPlacerExt, Object);
...
public:
    ...
    OpenSim_DECLARE_PROPERTY(coordinate_file_for_calibration, std::string,
            "Name/path to a .sto file of sensor frame orientations as "
            "quaternions to be used to place IMUs on the model.");
...
public:
    virtual ~IMUPlacerExt();
    IMUPlacerExt();
    /** Create an IMUPlacerExt based on a setup file */
    IMUPlacerExt(const std::string& setupFile);
